...
The Smart Product Review Analyzer is designed to assist users in understanding large volumes of product reviews, rather than making definitive judgments about reviewers or products.

* **Bias predictions are probabilistic:** A review classified as potentially biased should not be considered objectively false or misleading.
* **Synthetic labels:** Automatically generated bias labels may contain errors because they are produced using sentiment analysis and heuristic rules rather than human judgment.
* **Avoiding censorship:** Bias detection should be used as an informational signal and should not be used to automatically remove, suppress, or censor customer reviews.
* **Fairness:** Strong positive or negative opinions do not necessarily indicate bias. The system should account for different writing styles and legitimate customer experiences.
* **Transparency:** Users should be informed that summaries and bias predictions are generated by an AI model and may require human verification.
* **Data privacy:** The system should avoid collecting or exposing personally identifiable information contained within reviews and should process user-provided content responsibly.

## License

This project is released under the **MIT License**, allowing users to use, modify, distribute, and incorporate the software into other projects, subject to the terms of the license.
